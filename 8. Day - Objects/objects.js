...
//   }
// }
// console.log(`The most skilled person is ${mostSkilledPerson} with ${maxSkills} skills`);
...
function signUp(newUser) {
  ...
  if (userExists) {
    console.log(`User with username "${newUser.username}" already has an account.`);
    return;
  }

  // If user doesn't exist, add new user to users array
  users.push(newUser);
